 ...
 * @param servo_output_raw C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_servo_output_raw_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const void* servo_output_raw)
{
    return mavlink_msg_servo_output_raw_pack_chan(system_id, component_id, chan, msg, ((mavlink_servo_output_raw_t*)servo_output_raw)->time_usec, ((mavlink_servo_output_raw_t*)servo_output_raw)->port, ((mavlink_servo_output_raw_t*)servo_output_raw)->servo1_raw, ((mavlink_servo_output_raw_t*)servo_output_raw)->servo2_raw, ((mavlink_servo_output_raw_t*)servo_output_raw)->servo3_raw, ((mavlink_servo_output_raw_t*)servo_output_raw)->servo4_raw, ((mavlink_servo_output_raw_t*)servo_output_raw)->servo5_raw, ((mavlink_servo_output_raw_t*)servo_output_raw)->servo6_raw, ((mavlink_servo_output_raw_t*)servo_output_raw)->servo7_raw, ((mavlink_servo_output_raw_t*)servo_output_raw)->servo8_raw, ((mavlink_servo_output_raw_t*)servo_output_raw)->servo9_raw, ((mavlink_servo_output_raw_t*)servo_output_raw)->servo10_raw, ((mavlink_servo_output_raw_t*)servo_output_raw)->servo11_raw, ((mavlink_servo_output_raw_t*)servo_output_raw)->servo12_raw, ((mavlink_servo_output_raw_t*)servo_output_raw)->servo13_raw, ((mavlink_servo_output_raw_t*)servo_output_raw)->servo14_raw, ((mavlink_servo_output_raw_t*)servo_output_raw)->servo15_raw, ((mavlink_servo_output_raw_t*)servo_output_raw)->servo16_raw);
}

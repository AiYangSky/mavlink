 ...
 * @param onboard_computer_status C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_onboard_computer_status_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const void* onboard_computer_status)
{
    return mavlink_msg_onboard_computer_status_pack_chan(system_id, component_id, chan, msg, ((mavlink_onboard_computer_status_t*)onboard_computer_status)->time_usec, ((mavlink_onboard_computer_status_t*)onboard_computer_status)->uptime, ((mavlink_onboard_computer_status_t*)onboard_computer_status)->type, ((mavlink_onboard_computer_status_t*)onboard_computer_status)->cpu_cores, ((mavlink_onboard_computer_status_t*)onboard_computer_status)->cpu_combined, ((mavlink_onboard_computer_status_t*)onboard_computer_status)->gpu_cores, ((mavlink_onboard_computer_status_t*)onboard_computer_status)->gpu_combined, ((mavlink_onboard_computer_status_t*)onboard_computer_status)->temperature_board, ((mavlink_onboard_computer_status_t*)onboard_computer_status)->temperature_core, ((mavlink_onboard_computer_status_t*)onboard_computer_status)->fan_speed, ((mavlink_onboard_computer_status_t*)onboard_computer_status)->ram_usage, ((mavlink_onboard_computer_status_t*)onboard_computer_status)->ram_total, ((mavlink_onboard_computer_status_t*)onboard_computer_status)->storage_type, ((mavlink_onboard_computer_status_t*)onboard_computer_status)->storage_usage, ((mavlink_onboard_computer_status_t*)onboard_computer_status)->storage_total, ((mavlink_onboard_computer_status_t*)onboard_computer_status)->link_type, ((mavlink_onboard_computer_status_t*)onboard_computer_status)->link_tx_rate, ((mavlink_onboard_computer_status_t*)onboard_computer_status)->link_rx_rate, ((mavlink_onboard_computer_status_t*)onboard_computer_status)->link_tx_max, ((mavlink_onboard_computer_status_t*)onboard_computer_status)->link_rx_max);
}

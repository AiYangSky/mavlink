...
{
    return mavlink_msg_heartbeat_pack_chan(system_id, component_id, chan, msg, ((mavlink_heartbeat_t*)heartbeat)->type, ((mavlink_heartbeat_t*)heartbeat)->autopilot, ((mavlink_heartbeat_t*)heartbeat)->base_mode, ((mavlink_heartbeat_t*)heartbeat)->custom_mode, ((mavlink_heartbeat_t*)heartbeat)->system_status);
}

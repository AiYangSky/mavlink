 ...
 * @param control_system_state C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_control_system_state_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const void* control_system_state)
{
    return mavlink_msg_control_system_state_pack_chan(system_id, component_id, chan, msg, ((mavlink_control_system_state_t*)control_system_state)->time_usec, ((mavlink_control_system_state_t*)control_system_state)->x_acc, ((mavlink_control_system_state_t*)control_system_state)->y_acc, ((mavlink_control_system_state_t*)control_system_state)->z_acc, ((mavlink_control_system_state_t*)control_system_state)->x_vel, ((mavlink_control_system_state_t*)control_system_state)->y_vel, ((mavlink_control_system_state_t*)control_system_state)->z_vel, ((mavlink_control_system_state_t*)control_system_state)->x_pos, ((mavlink_control_system_state_t*)control_system_state)->y_pos, ((mavlink_control_system_state_t*)control_system_state)->z_pos, ((mavlink_control_system_state_t*)control_system_state)->airspeed, ((mavlink_control_system_state_t*)control_system_state)->vel_variance, ((mavlink_control_system_state_t*)control_system_state)->pos_variance, ((mavlink_control_system_state_t*)control_system_state)->q, ((mavlink_control_system_state_t*)control_system_state)->roll_rate, ((mavlink_control_system_state_t*)control_system_state)->pitch_rate, ((mavlink_control_system_state_t*)control_system_state)->yaw_rate);
}

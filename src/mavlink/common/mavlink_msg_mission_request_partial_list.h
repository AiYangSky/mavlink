 ...
 * @param mission_request_partial_list C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_mission_request_partial_list_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const void* mission_request_partial_list)
{
    return mavlink_msg_mission_request_partial_list_pack_chan(system_id, component_id, chan, msg, ((mavlink_mission_request_partial_list_t*)mission_request_partial_list)->target_system, ((mavlink_mission_request_partial_list_t*)mission_request_partial_list)->target_component, ((mavlink_mission_request_partial_list_t*)mission_request_partial_list)->start_index, ((mavlink_mission_request_partial_list_t*)mission_request_partial_list)->end_index, ((mavlink_mission_request_partial_list_t*)mission_request_partial_list)->mission_type);
}

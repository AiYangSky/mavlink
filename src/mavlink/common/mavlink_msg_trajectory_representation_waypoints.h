 ...
 * @param trajectory_representation_waypoints C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_trajectory_representation_waypoints_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const void* trajectory_representation_waypoints)
{
    return mavlink_msg_trajectory_representation_waypoints_pack_chan(system_id, component_id, chan, msg, ((mavlink_trajectory_representation_waypoints_t*)trajectory_representation_waypoints)->time_usec, ((mavlink_trajectory_representation_waypoints_t*)trajectory_representation_waypoints)->valid_points, ((mavlink_trajectory_representation_waypoints_t*)trajectory_representation_waypoints)->pos_x, ((mavlink_trajectory_representation_waypoints_t*)trajectory_representation_waypoints)->pos_y, ((mavlink_trajectory_representation_waypoints_t*)trajectory_representation_waypoints)->pos_z, ((mavlink_trajectory_representation_waypoints_t*)trajectory_representation_waypoints)->vel_x, ((mavlink_trajectory_representation_waypoints_t*)trajectory_representation_waypoints)->vel_y, ((mavlink_trajectory_representation_waypoints_t*)trajectory_representation_waypoints)->vel_z, ((mavlink_trajectory_representation_waypoints_t*)trajectory_representation_waypoints)->acc_x, ((mavlink_trajectory_representation_waypoints_t*)trajectory_representation_waypoints)->acc_y, ((mavlink_trajectory_representation_waypoints_t*)trajectory_representation_waypoints)->acc_z, ((mavlink_trajectory_representation_waypoints_t*)trajectory_representation_waypoints)->pos_yaw, ((mavlink_trajectory_representation_waypoints_t*)trajectory_representation_waypoints)->vel_yaw, ((mavlink_trajectory_representation_waypoints_t*)trajectory_representation_waypoints)->command);
}

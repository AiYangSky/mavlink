 ...
 * @param open_drone_id_system C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_open_drone_id_system_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const void* open_drone_id_system)
{
    return mavlink_msg_open_drone_id_system_pack_chan(system_id, component_id, chan, msg, ((mavlink_open_drone_id_system_t*)open_drone_id_system)->target_system, ((mavlink_open_drone_id_system_t*)open_drone_id_system)->target_component, ((mavlink_open_drone_id_system_t*)open_drone_id_system)->id_or_mac, ((mavlink_open_drone_id_system_t*)open_drone_id_system)->operator_location_type, ((mavlink_open_drone_id_system_t*)open_drone_id_system)->classification_type, ((mavlink_open_drone_id_system_t*)open_drone_id_system)->operator_latitude, ((mavlink_open_drone_id_system_t*)open_drone_id_system)->operator_longitude, ((mavlink_open_drone_id_system_t*)open_drone_id_system)->area_count, ((mavlink_open_drone_id_system_t*)open_drone_id_system)->area_radius, ((mavlink_open_drone_id_system_t*)open_drone_id_system)->area_ceiling, ((mavlink_open_drone_id_system_t*)open_drone_id_system)->area_floor, ((mavlink_open_drone_id_system_t*)open_drone_id_system)->category_eu, ((mavlink_open_drone_id_system_t*)open_drone_id_system)->class_eu, ((mavlink_open_drone_id_system_t*)open_drone_id_system)->operator_altitude_geo, ((mavlink_open_drone_id_system_t*)open_drone_id_system)->timestamp);
}

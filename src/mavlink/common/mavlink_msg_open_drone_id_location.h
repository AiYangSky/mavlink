 ...
 * @param open_drone_id_location C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_open_drone_id_location_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const void* open_drone_id_location)
{
    return mavlink_msg_open_drone_id_location_pack_chan(system_id, component_id, chan, msg, ((mavlink_open_drone_id_location_t*)open_drone_id_location)->target_system, ((mavlink_open_drone_id_location_t*)open_drone_id_location)->target_component, ((mavlink_open_drone_id_location_t*)open_drone_id_location)->id_or_mac, ((mavlink_open_drone_id_location_t*)open_drone_id_location)->status, ((mavlink_open_drone_id_location_t*)open_drone_id_location)->direction, ((mavlink_open_drone_id_location_t*)open_drone_id_location)->speed_horizontal, ((mavlink_open_drone_id_location_t*)open_drone_id_location)->speed_vertical, ((mavlink_open_drone_id_location_t*)open_drone_id_location)->latitude, ((mavlink_open_drone_id_location_t*)open_drone_id_location)->longitude, ((mavlink_open_drone_id_location_t*)open_drone_id_location)->altitude_barometric, ((mavlink_open_drone_id_location_t*)open_drone_id_location)->altitude_geodetic, ((mavlink_open_drone_id_location_t*)open_drone_id_location)->height_reference, ((mavlink_open_drone_id_location_t*)open_drone_id_location)->height, ((mavlink_open_drone_id_location_t*)open_drone_id_location)->horizontal_accuracy, ((mavlink_open_drone_id_location_t*)open_drone_id_location)->vertical_accuracy, ((mavlink_open_drone_id_location_t*)open_drone_id_location)->barometer_accuracy, ((mavlink_open_drone_id_location_t*)open_drone_id_location)->speed_accuracy, ((mavlink_open_drone_id_location_t*)open_drone_id_location)->timestamp, ((mavlink_open_drone_id_location_t*)open_drone_id_location)->timestamp_accuracy);
}

 ...
 * @param high_latency C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_high_latency_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const void* high_latency)
{
    return mavlink_msg_high_latency_pack_chan(system_id, component_id, chan, msg, ((mavlink_high_latency_t*)high_latency)->base_mode, ((mavlink_high_latency_t*)high_latency)->custom_mode, ((mavlink_high_latency_t*)high_latency)->landed_state, ((mavlink_high_latency_t*)high_latency)->roll, ((mavlink_high_latency_t*)high_latency)->pitch, ((mavlink_high_latency_t*)high_latency)->heading, ((mavlink_high_latency_t*)high_latency)->throttle, ((mavlink_high_latency_t*)high_latency)->heading_sp, ((mavlink_high_latency_t*)high_latency)->latitude, ((mavlink_high_latency_t*)high_latency)->longitude, ((mavlink_high_latency_t*)high_latency)->altitude_amsl, ((mavlink_high_latency_t*)high_latency)->altitude_sp, ((mavlink_high_latency_t*)high_latency)->airspeed, ((mavlink_high_latency_t*)high_latency)->airspeed_sp, ((mavlink_high_latency_t*)high_latency)->groundspeed, ((mavlink_high_latency_t*)high_latency)->climb_rate, ((mavlink_high_latency_t*)high_latency)->gps_nsat, ((mavlink_high_latency_t*)high_latency)->gps_fix_type, ((mavlink_high_latency_t*)high_latency)->battery_remaining, ((mavlink_high_latency_t*)high_latency)->temperature, ((mavlink_high_latency_t*)high_latency)->temperature_air, ((mavlink_high_latency_t*)high_latency)->failsafe, ((mavlink_high_latency_t*)high_latency)->wp_num, ((mavlink_high_latency_t*)high_latency)->wp_distance);
}

 ...
 * @param smart_battery_info C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_smart_battery_info_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const void* smart_battery_info)
{
    return mavlink_msg_smart_battery_info_pack_chan(system_id, component_id, chan, msg, ((mavlink_smart_battery_info_t*)smart_battery_info)->id, ((mavlink_smart_battery_info_t*)smart_battery_info)->battery_function, ((mavlink_smart_battery_info_t*)smart_battery_info)->type, ((mavlink_smart_battery_info_t*)smart_battery_info)->capacity_full_specification, ((mavlink_smart_battery_info_t*)smart_battery_info)->capacity_full, ((mavlink_smart_battery_info_t*)smart_battery_info)->cycle_count, ((mavlink_smart_battery_info_t*)smart_battery_info)->serial_number, ((mavlink_smart_battery_info_t*)smart_battery_info)->device_name, ((mavlink_smart_battery_info_t*)smart_battery_info)->weight, ((mavlink_smart_battery_info_t*)smart_battery_info)->discharge_minimum_voltage, ((mavlink_smart_battery_info_t*)smart_battery_info)->charging_minimum_voltage, ((mavlink_smart_battery_info_t*)smart_battery_info)->resting_minimum_voltage, ((mavlink_smart_battery_info_t*)smart_battery_info)->charging_maximum_voltage, ((mavlink_smart_battery_info_t*)smart_battery_info)->cells_in_series, ((mavlink_smart_battery_info_t*)smart_battery_info)->discharge_maximum_current, ((mavlink_smart_battery_info_t*)smart_battery_info)->discharge_maximum_burst_current, ((mavlink_smart_battery_info_t*)smart_battery_info)->manufacture_date);
}

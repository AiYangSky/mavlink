 ...
 * @param rc_channels_override C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_rc_channels_override_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const void* rc_channels_override)
{
    return mavlink_msg_rc_channels_override_pack_chan(system_id, component_id, chan, msg, ((mavlink_rc_channels_override_t*)rc_channels_override)->target_system, ((mavlink_rc_channels_override_t*)rc_channels_override)->target_component, ((mavlink_rc_channels_override_t*)rc_channels_override)->chan1_raw, ((mavlink_rc_channels_override_t*)rc_channels_override)->chan2_raw, ((mavlink_rc_channels_override_t*)rc_channels_override)->chan3_raw, ((mavlink_rc_channels_override_t*)rc_channels_override)->chan4_raw, ((mavlink_rc_channels_override_t*)rc_channels_override)->chan5_raw, ((mavlink_rc_channels_override_t*)rc_channels_override)->chan6_raw, ((mavlink_rc_channels_override_t*)rc_channels_override)->chan7_raw, ((mavlink_rc_channels_override_t*)rc_channels_override)->chan8_raw, ((mavlink_rc_channels_override_t*)rc_channels_override)->chan9_raw, ((mavlink_rc_channels_override_t*)rc_channels_override)->chan10_raw, ((mavlink_rc_channels_override_t*)rc_channels_override)->chan11_raw, ((mavlink_rc_channels_override_t*)rc_channels_override)->chan12_raw, ((mavlink_rc_channels_override_t*)rc_channels_override)->chan13_raw, ((mavlink_rc_channels_override_t*)rc_channels_override)->chan14_raw, ((mavlink_rc_channels_override_t*)rc_channels_override)->chan15_raw, ((mavlink_rc_channels_override_t*)rc_channels_override)->chan16_raw, ((mavlink_rc_channels_override_t*)rc_channels_override)->chan17_raw, ((mavlink_rc_channels_override_t*)rc_channels_override)->chan18_raw);
}

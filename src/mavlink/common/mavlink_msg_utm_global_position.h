 ...
 * @param utm_global_position C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_utm_global_position_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const void* utm_global_position)
{
    return mavlink_msg_utm_global_position_pack_chan(system_id, component_id, chan, msg, ((mavlink_utm_global_position_t*)utm_global_position)->time, ((mavlink_utm_global_position_t*)utm_global_position)->uas_id, ((mavlink_utm_global_position_t*)utm_global_position)->lat, ((mavlink_utm_global_position_t*)utm_global_position)->lon, ((mavlink_utm_global_position_t*)utm_global_position)->alt, ((mavlink_utm_global_position_t*)utm_global_position)->relative_alt, ((mavlink_utm_global_position_t*)utm_global_position)->vx, ((mavlink_utm_global_position_t*)utm_global_position)->vy, ((mavlink_utm_global_position_t*)utm_global_position)->vz, ((mavlink_utm_global_position_t*)utm_global_position)->h_acc, ((mavlink_utm_global_position_t*)utm_global_position)->v_acc, ((mavlink_utm_global_position_t*)utm_global_position)->vel_acc, ((mavlink_utm_global_position_t*)utm_global_position)->next_lat, ((mavlink_utm_global_position_t*)utm_global_position)->next_lon, ((mavlink_utm_global_position_t*)utm_global_position)->next_alt, ((mavlink_utm_global_position_t*)utm_global_position)->update_rate, ((mavlink_utm_global_position_t*)utm_global_position)->flight_state, ((mavlink_utm_global_position_t*)utm_global_position)->flags);
}

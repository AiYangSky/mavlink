 ...
 * @param log_request_data C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_log_request_data_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const void* log_request_data)
{
    return mavlink_msg_log_request_data_pack_chan(system_id, component_id, chan, msg, ((mavlink_log_request_data_t*)log_request_data)->target_system, ((mavlink_log_request_data_t*)log_request_data)->target_component, ((mavlink_log_request_data_t*)log_request_data)->id, ((mavlink_log_request_data_t*)log_request_data)->ofs, ((mavlink_log_request_data_t*)log_request_data)->count);
}

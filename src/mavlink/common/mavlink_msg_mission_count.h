 ...
 * @param mission_count C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_mission_count_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const void* mission_count)
{
    return mavlink_msg_mission_count_pack_chan(system_id, component_id, chan, msg, ((mavlink_mission_count_t*)mission_count)->target_system, ((mavlink_mission_count_t*)mission_count)->target_component, ((mavlink_mission_count_t*)mission_count)->count, ((mavlink_mission_count_t*)mission_count)->mission_type);
}

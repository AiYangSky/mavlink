 ...
 * @param param_request_list C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_param_request_list_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const void* param_request_list)
{
    return mavlink_msg_param_request_list_pack_chan(system_id, component_id, chan, msg, ((mavlink_param_request_list_t*)param_request_list)->target_system, ((mavlink_param_request_list_t*)param_request_list)->target_component);
}

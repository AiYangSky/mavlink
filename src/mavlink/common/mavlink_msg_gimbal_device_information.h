 ...
 * @param gimbal_device_information C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_gimbal_device_information_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const void* gimbal_device_information)
{
    return mavlink_msg_gimbal_device_information_pack_chan(system_id, component_id, chan, msg, ((mavlink_gimbal_device_information_t*)gimbal_device_information)->time_boot_ms, ((mavlink_gimbal_device_information_t*)gimbal_device_information)->vendor_name, ((mavlink_gimbal_device_information_t*)gimbal_device_information)->model_name, ((mavlink_gimbal_device_information_t*)gimbal_device_information)->custom_name, ((mavlink_gimbal_device_information_t*)gimbal_device_information)->firmware_version, ((mavlink_gimbal_device_information_t*)gimbal_device_information)->hardware_version, ((mavlink_gimbal_device_information_t*)gimbal_device_information)->uid, ((mavlink_gimbal_device_information_t*)gimbal_device_information)->cap_flags, ((mavlink_gimbal_device_information_t*)gimbal_device_information)->custom_cap_flags, ((mavlink_gimbal_device_information_t*)gimbal_device_information)->roll_min, ((mavlink_gimbal_device_information_t*)gimbal_device_information)->roll_max, ((mavlink_gimbal_device_information_t*)gimbal_device_information)->pitch_min, ((mavlink_gimbal_device_information_t*)gimbal_device_information)->pitch_max, ((mavlink_gimbal_device_information_t*)gimbal_device_information)->yaw_min, ((mavlink_gimbal_device_information_t*)gimbal_device_information)->yaw_max);
}

 ...
 * @param position_target_global_int C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_position_target_global_int_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const void* position_target_global_int)
{
    return mavlink_msg_position_target_global_int_pack_chan(system_id, component_id, chan, msg, ((mavlink_position_target_global_int_t*)position_target_global_int)->time_boot_ms, ((mavlink_position_target_global_int_t*)position_target_global_int)->coordinate_frame, ((mavlink_position_target_global_int_t*)position_target_global_int)->type_mask, ((mavlink_position_target_global_int_t*)position_target_global_int)->lat_int, ((mavlink_position_target_global_int_t*)position_target_global_int)->lon_int, ((mavlink_position_target_global_int_t*)position_target_global_int)->alt, ((mavlink_position_target_global_int_t*)position_target_global_int)->vx, ((mavlink_position_target_global_int_t*)position_target_global_int)->vy, ((mavlink_position_target_global_int_t*)position_target_global_int)->vz, ((mavlink_position_target_global_int_t*)position_target_global_int)->afx, ((mavlink_position_target_global_int_t*)position_target_global_int)->afy, ((mavlink_position_target_global_int_t*)position_target_global_int)->afz, ((mavlink_position_target_global_int_t*)position_target_global_int)->yaw, ((mavlink_position_target_global_int_t*)position_target_global_int)->yaw_rate);
}

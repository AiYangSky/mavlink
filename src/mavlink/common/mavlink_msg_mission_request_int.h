 ...
 * @param mission_request_int C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_mission_request_int_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const void* mission_request_int)
{
    return mavlink_msg_mission_request_int_pack_chan(system_id, component_id, chan, msg, ((mavlink_mission_request_int_t*)mission_request_int)->target_system, ((mavlink_mission_request_int_t*)mission_request_int)->target_component, ((mavlink_mission_request_int_t*)mission_request_int)->seq, ((mavlink_mission_request_int_t*)mission_request_int)->mission_type);
}

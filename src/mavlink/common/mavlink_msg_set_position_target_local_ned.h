 ...
 * @param set_position_target_local_ned C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_set_position_target_local_ned_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const void* set_position_target_local_ned)
{
    return mavlink_msg_set_position_target_local_ned_pack_chan(system_id, component_id, chan, msg, ((mavlink_set_position_target_local_ned_t*)set_position_target_local_ned)->time_boot_ms, ((mavlink_set_position_target_local_ned_t*)set_position_target_local_ned)->target_system, ((mavlink_set_position_target_local_ned_t*)set_position_target_local_ned)->target_component, ((mavlink_set_position_target_local_ned_t*)set_position_target_local_ned)->coordinate_frame, ((mavlink_set_position_target_local_ned_t*)set_position_target_local_ned)->type_mask, ((mavlink_set_position_target_local_ned_t*)set_position_target_local_ned)->x, ((mavlink_set_position_target_local_ned_t*)set_position_target_local_ned)->y, ((mavlink_set_position_target_local_ned_t*)set_position_target_local_ned)->z, ((mavlink_set_position_target_local_ned_t*)set_position_target_local_ned)->vx, ((mavlink_set_position_target_local_ned_t*)set_position_target_local_ned)->vy, ((mavlink_set_position_target_local_ned_t*)set_position_target_local_ned)->vz, ((mavlink_set_position_target_local_ned_t*)set_position_target_local_ned)->afx, ((mavlink_set_position_target_local_ned_t*)set_position_target_local_ned)->afy, ((mavlink_set_position_target_local_ned_t*)set_position_target_local_ned)->afz, ((mavlink_set_position_target_local_ned_t*)set_position_target_local_ned)->yaw, ((mavlink_set_position_target_local_ned_t*)set_position_target_local_ned)->yaw_rate);
}

 ...
 * @param autopilot_state_for_gimbal_device C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_autopilot_state_for_gimbal_device_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const void* autopilot_state_for_gimbal_device)
{
    return mavlink_msg_autopilot_state_for_gimbal_device_pack_chan(system_id, component_id, chan, msg, ((mavlink_autopilot_state_for_gimbal_device_t*)autopilot_state_for_gimbal_device)->target_system, ((mavlink_autopilot_state_for_gimbal_device_t*)autopilot_state_for_gimbal_device)->target_component, ((mavlink_autopilot_state_for_gimbal_device_t*)autopilot_state_for_gimbal_device)->time_boot_us, ((mavlink_autopilot_state_for_gimbal_device_t*)autopilot_state_for_gimbal_device)->q, ((mavlink_autopilot_state_for_gimbal_device_t*)autopilot_state_for_gimbal_device)->q_estimated_delay_us, ((mavlink_autopilot_state_for_gimbal_device_t*)autopilot_state_for_gimbal_device)->vx, ((mavlink_autopilot_state_for_gimbal_device_t*)autopilot_state_for_gimbal_device)->vy, ((mavlink_autopilot_state_for_gimbal_device_t*)autopilot_state_for_gimbal_device)->vz, ((mavlink_autopilot_state_for_gimbal_device_t*)autopilot_state_for_gimbal_device)->v_estimated_delay_us, ((mavlink_autopilot_state_for_gimbal_device_t*)autopilot_state_for_gimbal_device)->feed_forward_angular_velocity_z, ((mavlink_autopilot_state_for_gimbal_device_t*)autopilot_state_for_gimbal_device)->estimator_status, ((mavlink_autopilot_state_for_gimbal_device_t*)autopilot_state_for_gimbal_device)->landed_state);
}

 ...
 * @param param_request_read C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_param_request_read_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const void* param_request_read)
{
    return mavlink_msg_param_request_read_pack_chan(system_id, component_id, chan, msg, ((mavlink_param_request_read_t*)param_request_read)->target_system, ((mavlink_param_request_read_t*)param_request_read)->target_component, ((mavlink_param_request_read_t*)param_request_read)->param_id, ((mavlink_param_request_read_t*)param_request_read)->param_index);
}
